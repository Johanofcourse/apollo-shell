...
def check_live_impossible_values(conn):
    c = conn.cursor()
    for table in ["outage_events", "jea_outage_events", "talquin_outage_events", "fpuc_outage_events", "preco_outage_events", "fkec_outage_events", "tcec_outage_events", "erec_outage_events", "chelco_outage_events"]:
...
def check_live_bad_durations(conn):
    c = conn.cursor()
    for table in ["outage_events", "teco_incident_events", "duke_incident_events", "jea_outage_events", "tallahassee_incident_events", "talquin_outage_events", "fpuc_outage_events", "fpuc_incident_events", "preco_outage_events", "fkec_outage_events", "tcec_outage_events", "erec_outage_events", "chelco_outage_events"]:
...
def check_pipeline_health():
    ...
    health = db.get_pipeline_health(sources=["fpl", "weather", "teco", "duke", "jea", "tallahassee", "talquin", "fpuc", "preco", "fkec", "tcec", "erec", "chelco", "correlation"])
    db.close()
