...
- [x] Historical storm data backfilled — 11 storms so far (2021-2025),
...
- [ ] Connect live data to the historical storm dataset — e.g. "current
      ...
      across separate storm databases (11 so far) vs. consolidating
...
of conditions. Historical storm data (11 storms so far, 2021-2025)
covers a different, rarer category of outage entirely and doesn't
substitute for everyday-outage volume — and even across 11 storms, most
